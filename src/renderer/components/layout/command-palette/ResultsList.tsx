        ...
        <div className="flex-1 overflow-y-auto py-2 border-r border-white/5 custom-scrollbar">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    {cmd.description && (
                                        <div className={cn("text-[11px] truncate", isSelected ? "text-primary-foreground/70" : "text-muted-foreground/50")}>
                                            {cmd.description}
                                        </div>
                                    )}
                                </div>
            ...
            {noResults && (
                <div className="flex flex-col items-center justify-center h-full py-12 px-4 text-center">
                    ...
                    <div className="text-muted-foreground/50 text-xs">Try searching for chats, models, or settings</div>
                </div>
            )}
        </div>
    );
