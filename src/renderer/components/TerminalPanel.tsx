...
export function TerminalPanel({
    ...
    const createTerminal = (type: 'powershell' | 'cmd' | 'bash' | 'custom') => {
        ...
        const newTab: TerminalTab = {
            ...
            type,
            content: [`[${typeLabel}] Oturum başlatıldı...`, ''],
            inputHistory: [],
            historyIndex: -1,
            currentInput: '',
            ...
            if (cmd === 'cls' || cmd === 'clear') {
                ...
                setTabs(prev => prev.map(t => {
                    ...
                    return {
                        ...t,
                        cwd: newPath || t.cwd,
                        content: [...t.content, `Dizin değiştirildi: ${newPath}`],
                        isRunning: false
                    }
                }))
                return
            } else if (cmd === 'help') {
                output = `Kullanılabilir komutlar:\n  cls/clear - Ekranı temizle\n  pwd/cd - Mevcut dizini göster\n  cd <path> - Dizin değiştir\n  help - Yardım göster\n\nNot: Terminal henüz geliştirme aşamasındadır.`
            } else {
                output = `Komut simüle edildi: ${command}\n(Gerçek terminal entegrasyonu yakında eklenecek)`
            }
                ...
                {activeTab ? (
                    <div className="h-full flex flex-col bg-black/50 font-mono text-sm">
                        ...
                        <div className="flex items-center gap-2 px-3 py-2 border-t border-white/5 bg-zinc-950">
                            ...
                            <input
                                ...
                                placeholder={activeTab.isRunning ? "Çalışıyor..." : "Komut girin..."}
                                autoFocus
                            />
                        </div>
                    </div>
                    ...
                    <div className="h-full flex items-center justify-center text-muted-foreground">
                        <div className="text-center">
                            ...
                            <p className="text-sm">Yeni terminal açmak için + butonuna tıklayın</p>
                        </div>
                    </div>
                )}
            </div>
