                ...
                {categories.length === 0 ? (
                    ...
                    categories.map(category => (
                        <div key={category.id} className="mb-1">
                            <div className="px-3 py-1.5 text-xxs font-black uppercase tracking-widest text-muted-foreground flex items-center gap-2 bg-popover/95 sticky top-0 z-5 border-b border-border/50 shadow-sm">
