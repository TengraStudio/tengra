        ...
        <TerminalOverlays
            ...
            contextMenuProps={{
                ...
                labels: {
                    ...
                    copyWithFormatting: p.t('frontend.terminal.copyWithFormatting'),
                    copyStripAnsi: p.t('frontend.terminal.copyStripAnsi'),
                    paste: p.t('frontend.terminal.paste'),
                    pasteTest: p.t('frontend.terminal.pasteTest'),
                    pasteHistory: p.t('frontend.terminal.pasteHistory'),
                    selectAll: p.t('common.selectAll'),
                    search: p.t('common.search'),
                    semanticIssues: p.t('frontend.terminal.semanticIssues'),
                    galleryView: p.t('frontend.terminal.galleryView'),
                    exitGalleryView: p.t('frontend.terminal.exitGalleryView'),
                    dockTerminal: p.t('frontend.terminal.dockTerminal'),
                    commandHistory: p.t('frontend.terminal.commandHistory'),
                    runTask: p.t('frontend.terminal.runTask'),
                    startRecording: p.t('frontend.terminal.startRecording'),
                    stopRecording: p.t('frontend.terminal.stopRecording'),
                    sessionRecordings: p.t('frontend.terminal.recordingsTitle'),
                    clearOutput: p.t('frontend.terminal.clearOutput'),
                    split: p.t('frontend.terminal.split'),
                    synchronizedInputOn: p.t('frontend.terminal.disableSynchronizedInput'),
                    synchronizedInputOff: p.t('frontend.terminal.enableSynchronizedInput'),
                    detach: p.t('frontend.terminal.detach'),
                    toggleSplitOrientation: p.t('frontend.terminal.toggleSplitOrientation'),
                    closeSplit: p.t('frontend.terminal.closeSplit'),
                    newTerminal: p.t('frontend.terminal.new'),
                    hide: p.t('frontend.terminal.hide'),
                },
            }}
            semanticPanelProps={
