    ...
    return (
        ...
        >
            <TerminalPanelToolbarConnector
                ...
                isMultiplexerOpen={core.isMultiplexerOpen}
            ...
            <TerminalPanelOverlaysConnector
                ...
                setIsMultiplexerOpen={core.setIsMultiplexerOpen}
                setIsRecordingPanelOpen={core.setIsRecordingPanelOpen}
                isMultiplexerOpen={core.isMultiplexerOpen}
                multiplexerMode={core.multiplexer.multiplexerMode}
                multiplexerSessionName={core.multiplexer.multiplexerSessionName}
                multiplexerSessions={core.multiplexer.multiplexerSessions}
                isMultiplexerLoading={core.multiplexer.isMultiplexerLoading}
                multiplexerError={core.multiplexer.multiplexerError}
                closeMultiplexerPanel={core.closeMultiplexerPanel}
                setMultiplexerMode={core.multiplexer.setMultiplexerMode}
                refreshMultiplexerSessions={core.multiplexer.refreshMultiplexerSessions}
                setMultiplexerSessionName={core.multiplexer.setMultiplexerSessionName}
                createMultiplexerSession={core.createMultiplexerSession}
                attachMultiplexerSession={core.attachMultiplexerSession}
