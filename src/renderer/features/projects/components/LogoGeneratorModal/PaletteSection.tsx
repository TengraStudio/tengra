            ...
            <div className="flex items-center gap-2 pt-1">
                {palette.map((c, i) => (
                    ...
                    >
                        ...
                        />
                        <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-background text-[8px] px-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50">
                            {c}
                        </div>
                    </button>
                ))}
