        ...
        <div className="flex flex-col items-center justify-center flex-1 h-full py-12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl mx-auto px-2">
                ...
                >
                    ...
                    <div className="w-24 h-24 rounded-3xl bg-purple/5 flex items-center justify-center text-purple mb-6 ring-1 ring-purple-500/10 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                ...
                >
                    ...
                    <div className="w-24 h-24 rounded-3xl bg-primary/10 flex items-center justify-center text-primary mb-6 ring-1 ring-blue-500/20 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
