...
import { CommandStrip } from '@/features/projects/components/workspace/CommandStrip';
import { ProjectExplorerPanel } from '@/features/projects/components/workspace/ProjectExplorerPanel';
import { ShortcutHelpOverlay } from '@/features/projects/components/workspace/ShortcutHelpOverlay';
import { WorkspaceDialogs } from '@/features/projects/components/workspace/WorkspaceDialogs';
import { WorkspaceMain } from '@/features/projects/components/workspace/WorkspaceMain';
import { WorkspaceNotifications } from '@/features/projects/components/workspace/WorkspaceNotifications';
import { WorkspaceQuickSwitch } from '@/features/projects/components/workspace/WorkspaceQuickSwitch';
import { WorkspaceSidebar } from '@/features/projects/components/workspace/WorkspaceSidebar';
import { WorkspaceTerminalLayer } from '@/features/projects/components/workspace/WorkspaceTerminalLayer';
import { WorkspaceToolbar } from '@/features/projects/components/workspace/WorkspaceToolbar';
import { useProjectWorkspaceController } from '@/features/projects/hooks/useProjectWorkspaceController';
import { useQuickSwitch } from '@/features/projects/hooks/useQuickSwitch';
...
export const ProjectWorkspace: React.FC<ProjectWorkspaceProps> = ({
    ...
    useWorkspaceShortcuts(
        wm,
        qs.setShowShortcutHelp,
        qs.setShowQuickSwitch,
        qs.setQuickSwitchQuery,
        qs.setQuickSwitchIndex,
        ps.showTerminal,
        ps.setShowTerminal,
        tl.isFloatingTerminal,
        tl.setIsFloatingTerminal,
        tl.setIsMaximizedTerminal,
        ps.setTerminalHeight,
        tl.lastExpandedTerminalHeightRef
    );
