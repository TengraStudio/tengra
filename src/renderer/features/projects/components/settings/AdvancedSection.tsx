...
export const AdvancedSection: React.FC<SettingsSectionProps> = ({ formData, setFormData, t }) => (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div>
            <h3 className="text-lg font-semibold text-white mb-1">{t('projects.advanced') || 'Advanced Settings'}</h3>
        ...
        <div className="space-y-4">
            <div className="p-4 bg-white/5 border border-white/10 rounded-xl space-y-3">
                <div className="flex items-center justify-between">
                    <div>
                        <div className="text-sm font-medium text-white">{t('projects.fileWatching') || 'File Watching'}</div>
                    ...
                    <input
                        ...
                        className="rounded border-white/10 bg-white/5 text-primary focus:ring-primary h-5 w-5"
                    />
                </div>
            </div>
            ...
            <div className="p-4 bg-white/5 border border-white/10 rounded-xl space-y-3">
                <div className="flex items-center justify-between">
                    <div>
                        <div className="text-sm font-medium text-white">{t('projects.indexing') || 'Code Indexing'}</div>
            ...
            <div className="p-4 bg-white/5 border border-white/10 rounded-xl space-y-3">
                <div className="flex items-center justify-between">
                    <div>
                        <div className="text-sm font-medium text-white">{t('projects.autoSave') || 'Auto-Save'}</div>
