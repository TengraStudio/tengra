        ...
        return (
            <div className="h-full flex flex-col items-center justify-center p-6 bg-tech-grid">
                <div className="glass-panel p-8 rounded-2xl border border-destructive/30 flex flex-col items-center gap-4 text-center max-w-md">
                    ...
                    <div className="mt-4 px-4 py-2 bg-muted/30 rounded-lg text-sm font-mono text-muted-foreground">
                        VIEW_ID: {viewId}
                    </div>
                </div>
            </div>
            ...
            <div className="h-full flex flex-col items-center justify-center p-6 bg-tech-grid bg-tech-grid-sm">
                <div className="glass-panel p-8 rounded-2xl border border-border/50 flex flex-col items-center gap-6">
                    <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center">
                        <IconTerminal className="w-8 h-8 text-primary animate-pulse" />
                    </div>
                    <div className="space-y-2 text-center">
                        <h2 className="typo-h2 text-foreground font-bold ">
                    ...
                    <div className="flex gap-2">
                        <div className="px-3 py-1 rounded-full bg-muted/50 text-sm font-mono text-muted-foreground border border-border/30">
                            ID: {activeExtension?.manifest.id}
                        </div>
                        <div className="px-3 py-1 rounded-full bg-success/10 text-sm font-mono text-success border border-success/20">
                            ACTIVE
                        </div>
                    </div>
                </div>
