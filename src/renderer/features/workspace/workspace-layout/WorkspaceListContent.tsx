...
import { useWorkspaceListStateMachine } from '@/features/workspace/hooks/useWorkspaceListStateMachine';
...
export const WorkspaceListContent: React.FC<WorkspaceListContentProps> = ({
    ...
    return (
        <div className="rounded-2xl border border-border/40 overflow-hidden bg-card animate-in fade-in slide-in-from-bottom-2 duration-400 shadow-sm">
            <div className="grid grid-cols-todo gap-3 px-6 py-4 bg-muted/20 border-b border-border/20 typo-overline font-bold uppercase text-muted-foreground">
                <div />
                <button
