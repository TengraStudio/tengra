...
import { IconLock, IconRadio, IconRobot, IconUsers } from '@tabler/icons-react';
    ...
    return (
        <div className="rounded-xl border border-border/40 bg-background/70 px-3 py-3">
            <div className="flex items-center justify-between gap-3">
                ...
                <div
                    className={cn(
                        'flex items-center gap-1 typo-overline font-semibold ',
                    ...
                    <div className="mt-2 space-y-1.5">
                        {feedEntries.map(entry => (
                            ...
                            >
                                ...
                                <div
                                    className={cn(
                                        'shrink-0 typo-overline font-semibold ',
