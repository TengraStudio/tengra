...
export const WorkspaceSection: React.FC<WorkspaceSectionProps> = ({
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4 px-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-muted-foreground font-mono mt-0.5 truncate max-w-lg opacity-70 group-hover:opacity-100 transition-opacity">
                                        {mount.rootPath}
                                    </div>
                                </div>
                            </div>
            ...
            {workspace.mounts.length === 0 && (
                <Card className="border-dashed border-2 bg-muted/5 py-12 flex flex-col items-center justify-center text-center">
                    <FolderTree className="w-12 h-12 text-muted-foreground/20 mb-4" />
        ...
        <div className="pt-10">
            <h3 className="text-xs font-bold text-destructive uppercase tracking-widest mb-4 flex items-center gap-2">
