...
import { GitData, DiffStats } from './types';
    ...
    return (
        <div className="space-y-6">
            <div className="space-y-3">
                <span className="text-[11px] font-bold text-muted-foreground/60 uppercase tracking-widest px-1">{t('workspaceDashboard.gitSectionStatus')}</span>
                ...
                <div className="p-4 rounded-xl bg-card border border-border/40 space-y-5">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] font-bold text-muted-foreground/40 bg-muted/50 px-2 py-0.5 rounded uppercase tracking-tighter">
                            {gitData.branch}
                        </span>
                    </div>
                    ...
                    {!gitData.isClean ? (
                        <div className="grid grid-cols-1 gap-3">
                            <div className="text-[10px] font-bold text-muted-foreground/30 uppercase tracking-widest mb-1 px-1">{t('workspaceDashboard.status')}</div>
                            <div className="space-y-2.5">
                                ...
                                {diffStats && (
                                    <div className="pt-2 border-t border-border/5 mt-2 flex items-center gap-4 text-[11px] font-medium px-1">
                        ...
                        <div className="flex flex-col items-center gap-3 py-4 text-center opacity-40 grayscale">
                            ...
                            <p className="text-[10px] font-bold uppercase tracking-widest">{t('workspaceDashboard.clean')}</p>
                        </div>
                    )}
