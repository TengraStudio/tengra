            ...
            <div className="flex flex-col gap-1 border-b border-border/50 px-3 pb-2 pt-2.5">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <div className="flex items-center gap-0.5">
                        <SearchToggleButton icon={<CaseSensitive className="h-4 w-4" />} title="Match Case" />
                        <SearchToggleButton icon={<WholeWord className="h-4 w-4" />} title="Match Whole Word" />
                        <SearchToggleButton icon={<Regex className="h-4 w-4" />} title="Use Regular Expression" />
                    </div>
                </div>
