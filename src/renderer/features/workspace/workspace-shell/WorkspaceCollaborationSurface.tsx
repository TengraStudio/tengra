    ...
    return (
        <div className="rounded-xl border border-border/40 bg-background/70 px-3 py-3">
            <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2 typo-overline font-semibold tracking-18 text-muted-foreground/60">
                    <Users className="h-3.5 w-3.5" />
                    <span>{t('chat.collaboration.presence')}</span>
                </div>
                <div
                    className={cn(
                        'flex items-center gap-1 typo-overline font-semibold  tracking-18',
            ...
            <div className="mt-3 flex flex-wrap gap-2">
                {presenceEntries.map(entry => (
                    <div
                        key={entry.actorId}
                        className={cn(
                            'flex min-w-140 items-center gap-2 rounded-lg border px-2.5 py-2 typo-caption',
                            entry.isLocal
            ...
            {feedEntries.length > 0 && (
                <div className="mt-3 border-t border-border/40 pt-3">
                    <div className="typo-overline font-semibold tracking-18 text-muted-foreground/60">
                        {t('agent.history')}
                    </div>
                    <div className="mt-2 space-y-1.5">
                        {feedEntries.map(entry => (
                            ...
                            >
                                ...
                                <div
                                    className={cn(
                                        'shrink-0 typo-overline font-semibold  tracking-16',
