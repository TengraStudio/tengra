    ...
    return (
        <div className="rounded-xl border border-border/40 bg-background/70 px-3 py-3">
            <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2 text-11 font-semibold tracking-18 text-muted-foreground/60">
                    <Users className="h-3.5 w-3.5" />
                    <span>{t('chat.collaboration.presence')}</span>
                </div>
                <div
                    className={cn(
                        'flex items-center gap-1 text-10 font-semibold  tracking-18',
            ...
            {feedEntries.length > 0 && (
                <div className="mt-3 border-t border-border/40 pt-3">
                    <div className="text-11 font-semibold tracking-18 text-muted-foreground/60">
                        {t('agent.history')}
                    </div>
                    <div className="mt-2 space-y-1.5">
                        {feedEntries.map(entry => (
                            ...
                            >
                                ...
                                <div
                                    className={cn(
                                        'shrink-0 text-10 font-semibold  tracking-16',
