    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="border-border/40 bg-card backdrop-blur-md overflow-hidden relative group hover:bg-card/90 transition-all duration-300">
                ...
                <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                        <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">{t('statistics.messages')}</CardTitle>
                        <MessageSquare className="w-4 h-4 text-primary/50" />
                    </div>
                </CardHeader>
                <CardContent>
                    <div className="text-4xl font-black text-foreground leading-none tracking-tighter tabular-nums">{statsData?.messageCount ?? 0}</div>
            ...
            <Card className="border-border/40 bg-card backdrop-blur-md overflow-hidden relative group hover:bg-card/90 transition-all duration-300">
                ...
                <CardContent>
                    <div className="text-4xl font-black text-foreground leading-none tracking-tighter tabular-nums">{statsData?.chatCount ?? 0}</div>
                ...
                <CardContent>
                    <div className="space-y-4">
                        <div className="flex items-end justify-between gap-4">
                            <div className="text-4xl font-black text-foreground leading-none tracking-tighter tabular-nums">{formatNumber(statsData?.totalTokens ?? 0)}</div>
                        </div>
