        ...
        <div className="space-y-6">
            <div className="bg-card p-6 rounded-xl border border-border space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                    ...
                    <textarea placeholder={t('personas.promptPlaceholder')} value={personaDraft.prompt} onChange={e => setPersonaDraft({ ...personaDraft, prompt: e.target.value })} className="w-full bg-muted/20 border border-border/50 rounded-lg px-3 py-2 text-sm text-foreground tw-min-h-120" />
