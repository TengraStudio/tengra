...
import { useAddModal, useAdvancedMemoryData, useEditModal } from '../hooks/useAdvancedMemory';
...
const TabContent: React.FC<{
    activeTab: TabType,
    memoryData: ReturnType<typeof useAdvancedMemoryData>,
...
function useMemoryInspectorLogic(
    ...
    const memoryData = useAdvancedMemoryData(searchQuery, activeTab);
