...
export const NginxWizard: React.FC<NginxWizardProps> = ({ connectionId }) => {
        ...
        <div className="flex flex-col h-full bg-background p-6 overflow-y-auto">
            <div className="max-w-2xl mx-auto w-full space-y-6">
                <div className="flex items-center gap-3 border-b border-border pb-4">
                    ...
                    <div>
                        <h2 className="text-xl font-semibold">Nginx Reverse Proxy Wizard</h2>
                        <p className="text-sm text-muted-foreground">Easily expose your backend application through a domain.</p>
                    </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        <label className="text-xs font-bold uppercase text-muted-foreground tracking-wider">Domain Name</label>
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-bold uppercase text-muted-foreground tracking-wider">Internal Port</label>
                        <input
                            type="number"
                            value={backendPort}
                ...
                {config && (
                    <div className="space-y-2 pt-4">
                        <label className="text-xs font-bold uppercase text-muted-foreground tracking-wider">Configuration Preview</label>
