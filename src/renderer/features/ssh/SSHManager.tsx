                        ...
                        {activeTab === 'terminal' ? (
                            <div className="flex-1 p-4 flex flex-col bg-background">
                                <div style={{
                                    ...
                                    {terminalOutput || 'Terminal Ã§Ä±ktÄ±sÄ± burada gÃ¶rÃ¼necek...'}
                                </div>
                                <div style={{ display: 'flex', gap: '8px' }}>
                                    <input
                                        type="text"
                                        placeholder="Komut Ã§alÄ±ÅŸtÄ±r..."
                                        ...
                                        onKeyDown={(e) => {
                                            if (e.key === 'Enter') {
                                                ...
                                                if (selectedConnectionId) {
                                                    ...
                                                    setTerminalOutput(prev => prev + 'BaÄŸlÄ± sunucu yok!\n')
                                                }
                                            }
                                        }}
                                    />
                    ...
                    <div className="modal-overlay" style={{ zIndex: 1000 }}>
                        <div className="modal-content" style={{ width: '400px' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', marginTop: '16px' }}>
                                <button onClick={() => setShowAddModal(false)}>Ä°ptal</button>
