...
const C_PERMISSIONERRORCARD_4 = "flex h-10 items-center justify-center gap-2 rounded-xl bg-destructive px-6 typo-overline font-bold tracking-20 text-destructive-foreground shadow-lg shadow-destructive/20 transition-all hover:-translate-y-0.5 hover:bg-destructive/90 active:translate-y-0";
            ...
            <div className="relative flex flex-col gap-5">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                        <h3 className="typo-overline font-bold tracking-20 text-foreground">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="typo-overline font-bold tracking-40 text-muted-foreground/40 uppercase">
