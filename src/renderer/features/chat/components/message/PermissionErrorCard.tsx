...
const C_PERMISSIONERRORCARD_4 = "flex h-10 items-center justify-center gap-2 rounded-xl bg-destructive px-6 typo-overline font-bold text-destructive-foreground shadow-lg shadow-destructive/20 transition-all hover:-translate-y-0.5 hover:bg-destructive/90 active:translate-y-0";
