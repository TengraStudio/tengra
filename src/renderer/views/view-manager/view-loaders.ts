...
const loadIdeasPageView = () =>
    import('@/features/ideas/IdeasPage').then(module => ({ default: module.IdeasPage }));
...
export const IdeasPageView = lazy(loadIdeasPageView);
