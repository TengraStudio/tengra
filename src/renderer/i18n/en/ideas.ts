const sectionData = {
    ...
    "errors": {
        ...
        "cancelSessionFailed": "Failed to cancel session. Please try again.",
        "rejectFailed": "Failed to reject idea. Please try again.",
        "archiveFailed": "Failed to archive idea. Please try again.",
        "maxIdeasReached": "Maximum ideas have already been generated for this session.",
        "logoNoImageGenerated": "No logo image was generated by the selected provider.",
