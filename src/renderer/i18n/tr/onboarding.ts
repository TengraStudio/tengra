const sectionData = {
    ...
    "workspaceDescription": "Çalışma Alanlarını düzenleyin, konuşmaları yönetin ve kodlama geçmişinize erişin. Her şey bilgisayarınızda yerel ve güvenli kalır.",
    ...
    "step3Title": "Çalışma Alanları ve Çalışma Alanları",
    "step3Desc": "Çalışmalarınızı çalışma alanlarıyla düzenleyin. Her çalışma alanı, daha akıllı öneriler için kendi bağlamını, sohbet geçmişini ve AI belleğini korur.",
