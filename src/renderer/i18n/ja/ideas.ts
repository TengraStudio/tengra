const sectionData = {
    "title": "ワークスペースアイデア",
    "subtitle": "市場調査を伴うAI駆動のワークスペースアイデア生成",
    "newSession": "新規セッション",
    ...
    "idea": {
        ...
        "marketTrends": "市場動向",
        "competitors": "競合他社",
        "selectPath": "ワークスペースパスを選択",
        "creating": "ワークスペースを作成中...",
        "detailedDescription": "詳細な説明",
        "roadmap": "ワークスペースロードマップ",
        "techStack": "技術スタック",
        "competitorAnalysis": "競合分析",
        "archive": "アーカイブ",
        "archiving": "アーカイブ中...",
        "pathPlaceholder": "C:\\ワークスペース\\私のワークスペース",
        "technicalDetails": "技術的な詳細",
        "impact": "インパクト",
        "impactHigh": "高い (推定)",
        "effort": "努力",
        "effortMedium": "中くらい",
        "openFullWorkspace": "完全なワークスペースを開く"
    },
    "techStack": {
        "frontend": "フロントエンド",
        "backend": "バックエンド",
    ...
    "errors": {
        ...
        "approvalFailed": "ワークスペースの作成に失敗しました。もう一度お試しください。",
        "logoFailed": "ロゴ生成に失敗しました。もう一度お試しください。"
    },
    "empty": {
        "noSessions": "アイデアセッションはまだありません",
        "noSessionsDesc": "新しいセッションを開始してワークスペースアイデアを生成しましょう",
