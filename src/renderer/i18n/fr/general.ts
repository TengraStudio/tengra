const sectionData = {
    ...
    "workspaceBasics": "Bases de l'espace de travail",
    "workspaceBasicsDesc": "Paramètres de l'espace de travail principal",
    "appIntelligence": "Intelligence des applications",
    "appIntelligenceDesc": "Configurer les fonctionnalités de l'IA",
    "lifecycle": "Cycle de vie",
    "lifecycleDesc": "Gérer le cycle de vie de l'espace de travail",
