...
// Mock the utils
vi.mock('@renderer/features/projects/utils/workspaceUtils', () => ({
...
vi.mock('@renderer/features/projects/components/workspace/WorkspaceMountItem', () => ({
    WorkspaceMountItem: ({
        mount,
        isExpanded,
        onToggle,
...
vi.mock('@renderer/features/projects/components/workspace/WorkspaceContextMenu', () => ({
    ...
    describe('Mount Management', () => {
        ...
        it('should toggle mount expansion', async () => {
            const { useWorkspaceExplorerLogic } = await import(
                '@renderer/features/projects/hooks/useWorkspaceExplorerLogic'
            );
    ...
    describe('State Persistence', () => {
        it('should load expanded tree state on mount', async () => {
            const { loadExpandedTreeState } = await import(
                '@renderer/features/projects/utils/workspaceUtils'
            );
            render(<WorkspaceExplorer {...mockProps} />);
