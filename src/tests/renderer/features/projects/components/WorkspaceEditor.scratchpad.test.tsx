...
const {
    ...
    mockLoadProjectSnippets: vi.fn((): WorkspaceSnippet[] => []),
...
describe('WorkspaceEditor – scratchpad command & file-save', () => {
    ...
    describe('scratchpad command execution', () => {
        ...
        it('does not execute when projectPath is undefined', async () => {
    ...
    describe('save scratchpad as doc', () => {
        ...
        it('does not save doc when projectPath is undefined', async () => {
            render(<WorkspaceEditor {...createMockProps({ projectPath: undefined })} />);
    ...
    describe('save scratchpad as task', () => {
        ...
        it('does not save task when projectPath is undefined', async () => {
            render(<WorkspaceEditor {...createMockProps({ projectPath: undefined })} />);
