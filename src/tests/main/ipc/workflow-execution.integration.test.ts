...
interface MockWorkflowExecutionService extends Partial<WorkflowExecutionService> {
    start: Mock;
    stop: Mock;
    getStatus: Mock;
    generatePlan: Mock;
...
describe('Workflow Execution IPC Handlers', () => {
    let mockWorkflowExecutionService: MockWorkflowExecutionService;
    ...
    beforeEach(() => {
        ...
        registerWorkflowExecutionIpc(
            mockWorkflowExecutionService as unknown as WorkflowExecutionService,
            () => mockWindow,
    ...
    describe('Core Handlers', () => {
        ...
        it('should get workspace agent status', async () => {
            ...
            expect(mockWorkflowExecutionService.getStatus).toHaveBeenCalledWith('task-123');
    ...
    describe('HIL Handlers', () => {
        it('should approve a step', async () => {
            ...
            expect(mockWorkflowExecutionService.approveStep).toHaveBeenCalledWith('task-123', 'step-1');
        });
    });
    ...
    describe('Legacy Compatibility', () => {
        it('should keep old workspace-agent channels unregistered', () => {
            expect(registeredHandlers.has('workspace-agent:start-task')).toBe(false);
            expect(registeredHandlers.has('workspace-agent:health')).toBe(false);
        });
    });
    ...
    describe('Council IPC Handlers', () => {
        it('should generate council plan', async () => {
            ...
            expect(mockWorkflowExecutionService.generatePlan).toHaveBeenCalled();
        ...
        it('should approve council proposal', async () => {
            ...
            expect(mockWorkflowExecutionService.approveCurrentPlan).toHaveBeenCalledWith('task-123');
        ...
        it('should reject council proposal', async () => {
            ...
            expect(mockWorkflowExecutionService.rejectCurrentPlan).toHaveBeenCalledWith(
                'task-123',
                'Need revision'
            );
            expect(result).toEqual({ success: true, data: { success: true, error: undefined } });
        ...
        it('should start, pause and resume council execution', async () => {
            ...
            expect(mockWorkflowExecutionService.resumeTask).toHaveBeenCalledWith('task-123');
            expect(mockWorkflowExecutionService.pauseTask).toHaveBeenCalledWith('task-123');
        ...
        it('should get council timeline', async () => {
            ...
            expect(mockWorkflowExecutionService.getTaskEvents).toHaveBeenCalledWith('task-123');
        ...
        it('should register worker availability', async () => {
            ...
            expect(mockWorkflowExecutionService.registerWorkerAvailability).toHaveBeenCalledWith(
                payload
            );
        });
        ...
        it('should list available workers', async () => {
            ...
            expect(mockWorkflowExecutionService.listAvailableWorkers).toHaveBeenCalledWith(
                'task-123'
            );
        });
        ...
        it('should score helper candidates', async () => {
            ...
            expect(mockWorkflowExecutionService.scoreHelperCandidates).toHaveBeenCalledWith(payload);
        });
        ...
        it('should generate helper handoff package', async () => {
            ...
            expect(mockWorkflowExecutionService.generateHelperHandoffPackage).toHaveBeenCalledWith(
                payload
            );
        });
        ...
        it('should review helper merge gate', async () => {
            ...
            expect(mockWorkflowExecutionService.reviewHelperMergeGate).toHaveBeenCalledWith(payload);
        });
        ...
        it('should handle quota exhaustion with checkpoint and automatic continuation', async () => {
            ...
            expect(mockWorkflowExecutionService.handleQuotaExhaustedInterrupt).toHaveBeenCalledWith(
                payload
            );
            expect(result).toEqual({
                success: true,
        ...
        it('should send council collaboration messages with strict payloads', async () => {
            ...
            expect(mockWorkflowExecutionService.sendCollaborationMessage).toHaveBeenCalledWith(
                payload
            );
        ...
        it('should fetch council collaboration messages with strict filters', async () => {
            ...
            expect(mockWorkflowExecutionService.getCollaborationMessages).toHaveBeenCalledWith(
                payload
            );
            expect(result).toEqual({
                success: true,
        ...
        it('should cleanup expired council collaboration messages', async () => {
            ...
            expect(
                mockWorkflowExecutionService.cleanupExpiredCollaborationMessages
