...
export const WORKSPACE_COMPAT_INDEX_VALUES = {
    ...
    IDEAS_BY_SESSION_ID: joinSegments('_', IDX_SEGMENT, LEGACY_SINGULAR, IDEAS_SEGMENT, SESSION_SEGMENT, ID_SEGMENT),
    IDEAS_BY_STATUS: joinSegments('_', IDX_SEGMENT, LEGACY_SINGULAR, IDEAS_SEGMENT, STATUS_SEGMENT),
