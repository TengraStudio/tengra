...
/**
 * Status for a single workspace agent step
 */
export const WorkspaceStepStatusSchema = z.enum([
    'pending',
    'running',
    'completed',
    'failed',
...
/**
 * AGT-PLN: Individual workspace agent execution step
 */
/**
 * AGT-PLN: Individual workspace agent execution step
 */
export const WorkspaceAgentStepSchema = z.object({
    id: z.string(),
    text: z.string(),
    status: WorkspaceStepStatusSchema,
...
/**
 * MARCH1-IPC-001: Workspace agent state for UI synchronization
 */
/**
 * MARCH1-IPC-001: Workspace agent state for UI synchronization
 */
export const WorkspaceStateSchema = z.object({
    ...
    plan: z.array(WorkspaceAgentStepSchema),
