...
export async function createServices(allowedFileRoots: Set<string>) {
    ...
    const embeddingService = new EmbeddingService(databaseService, ollamaService, llmService, llamaService, settingsService)
    ...
    const agentCouncilService = new AgentCouncilService(
        llmService,
        databaseService,
        fileSystemService,
        processService,
