...
interface ProjectAgentCollaborationManagerDeps {
    databaseService: DatabaseService;
    collaborationService: AgentCollaborationService;
}

export class ProjectAgentCollaborationManager {
    constructor(private readonly deps: ProjectAgentCollaborationManagerDeps) {}
