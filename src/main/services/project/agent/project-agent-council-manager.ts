...
import { ProjectAgentTaskManager } from '@main/services/project/agent/project-agent-task-manager';
import {
...
export interface ProjectAgentCouncilManagerDependencies {
    databaseService: DatabaseService;
    collaborationManager: ProjectAgentCollaborationManager;
    taskManager: ProjectAgentTaskManager;
}

export class ProjectAgentCouncilManager {
    ...
    constructor(deps: ProjectAgentCouncilManagerDependencies) {
