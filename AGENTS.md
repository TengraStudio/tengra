...
1. Read [docs/AI_RULES.md](docs/AI_RULES.md) - Comprehensive coding standards
2. Check [docs/TODO.md](docs/TODO.md) - Current tasks and priorities
3. Follow [.agent/rules/MASTER_COMMANDMENTS.md](.agent/rules/MASTER_COMMANDMENTS.md) - Core rules
